...
#Hand detector
detector = HandDetector(detectionCon=0.1, maxHands= 2) #sure 80 = detect
#loop part
    ...
    def HanddetecRL(self,req):
        ...
        while True:#while time.time() < end:
            ...
            if hands: #return back khar tee dai
                ...
                if self.fingers1 == [0,1,0,0,0] :
                    self.CodeName = 'Nubber one'
                    if self.fingers2 == [0,1,0,0,0]:
                        self.CodeName = "11"
                    elif self.fingers2 == [0,1,1,0,0]:
                        self.CodeName = "12"
                    elif self.fingers2 == [0,1,1,1,0]:
                        self.CodeName = "13"
                    elif self.fingers2 == [0,1,1,1,1]:
                        self.CodeName = "14"
                    elif self.fingers2 == [1,1,1,1,1]:
                        self.CodeName = "15"

                elif self.fingers1 == [0,1,1,0,0] :
