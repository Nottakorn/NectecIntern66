...
_API_KEY = "djwoRamy0TutE7UGYtCEzEbQoMTshSgf"
_CLIENT_ID = ""
...
def run():
    ...
    #pub = rospy.Publisher('microphone',TextWithMic,queue_size=1)
...
if __name__ == '__main__':
    ...
    _ENABLE_SPEAKER_DIARIZATION = config['DEFAULT']['_ENABLE_SPEAKER_DIARIZATION'] #not support yet
